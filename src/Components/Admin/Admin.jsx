        ...
        <div>
         <section className="p-3 flex flex-col md:flex-row rounded-xl">
          <div className="w-full md:w-1/5 md:h-screen bg-purple-300 ">
            <Link to="/volList"><p className="mt-3 px-4 text-white py-2  ">Voluntier List</p></Link>
            <Link to="/addEvent"><p className="text-white px-4 py-2"> + Add Event</p></Link>
          </div>
          <div className="w-full md:flex-1 md:w-3/4 bg-slate-200">
          <section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto ">
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-900">Volunetier List</h1>
